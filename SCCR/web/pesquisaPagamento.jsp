...
<html>
    <head>
        ...
        <title>Incricoes Realizadas</title>
                        ...
                        <tbody id="idTable">
                            ...
                            <c:forEach items="${inscricoes}" var="inscricao">
                                <tr>
                                    ...
                                    <td><c:if test="${inscricao.pago ==1}">Inscricao Paga</c:if></td>
                                    <td><c:if test="${inscricao.pago ==0}">Inscricao Não Pago</c:if></td>
