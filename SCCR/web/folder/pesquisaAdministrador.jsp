        ...
        <table border='1'>    
            ...
            <c:forEach items="${administradores}" var="administradores">
                <tr>
                    ...
                    <td><c:out value = "${administradores.id}" /></td>
                    <td><c:out value = "${administradores.nome}" /></td>
                    <td><c:out value = "${administradores.senha}" /></td>
                    <td><c:out value = "${administradores.login}" /></td>
                    <td><c:out value = "${administradores.email}" /></td>
