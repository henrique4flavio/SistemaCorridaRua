                ...
                <div class="row">
                    <div class="col-md-2">
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="number" required name="txtCpf" class="form-control" value="${atleta.cpf}" <c:if test="${operacao == 'Excluir'}"> readonly</c:if>>
                        </div>
                        ...
                        <div class="col-md-2">
                            ...
                            <input type="date" required name="txtDataNascimento" class="form-control" value="${atleta.dataNascimento}" <c:if test="${operacao == 'Excluir'}"> readonly</c:if>>
                        </div>
                        ...
                        <div class="col-md-4">
                            ...
                            <select class="form-control" name="txtEstadoAtleta" value="${atleta.estado}" <c:if test="${operacao == 'Excluir'}"> readonly</c:if>>
                    ...
                    <div class="row">
                        <div class="col-md-2">
                            ...
                            <input type="tel" name="txtTelefoneFixo" class="form-control" value="${atleta.telefoneFixo}" <c:if test="${operacao == 'Excluir'}"> readonly</c:if>>
                        </div>
                        <div class="col-md-2">
                            <label for="exampleInputPassword1">Telefone Celular:</label>
                            <input type="tel" name="txtTelefoneCelular" class="form-control" value="${atleta.telefoneCel}" <c:if test="${operacao == 'Excluir'}"> readonly</c:if>>
                        </div>

                        <div class="col-md-4">
                            <label for="exampleInputPassword1">Email:</label>
                            <input type="email" placeholder = "exemplo@corrida.com"required name="txtEmail" class="form-control" value="${atleta.email}" <c:if test="${operacao == 'Excluir'}"> readonly</c:if>>
                        </div>

                        <div class="col-md-4">
                            <label for="exampleInputPassword1">Confirmar Email:</label>
                            <input type="email" required id="email" name="txtEmail" class="form-control" oninput="validaEmail(this)" <c:if test="${operacao == 'Excluir'}"> readonly</c:if>>
                        </div>
