...
@Controller
@RequestMapping("/relatorioProvas")

public class RelatorioProvasController extends HttpServlet {

    @GetMapping(value = "provas")
    @ResponseBody
    public String RelatorioOrganizadores(HttpServletResponse response, HttpServletRequest request) throws JRException, IOException, ClassNotFoundException, SQLException {
        ...
        response.setHeader("Content-Disposition", "attachment;filename=Relatorio Provas.pdf");
        response.setContentType("application/x-pdf");
